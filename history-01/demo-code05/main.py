    ...
    def update_data_panel(self, panel, keypoints, match_results):
        ...
        for category, templates in self.templates.items():
            for i, template in enumerate(templates):
                ...
                template_label = tk.Label(template_frame, text=f"{template_name} Matches: {match_count}",
    ...
    def match_all_templates(self, current_keypoints):
        ...
        for category, templates in self.templates.items():
            for template in templates:
                ...
                is_match = self.compare_keypoints(current_keypoints, template_keypoints, category)
                if is_match:
                ...
                match_results[category][template_name] = is_match
