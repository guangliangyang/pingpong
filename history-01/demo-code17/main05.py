...
def draw_large_chessboard_pattern(frame,
    ...
    return output_image, normalized_chessboard_vertices
...
class PoseEstimation:
    ...
    def update_data_panel(self, panel, keypoints, match_results, current_speed, max_speed, avg_speed, swing_count, step_count):
        ...
        for category, templates in self.templates.items():
            ...
            for template in templates:
                ...
                #match_info.bind("<Double-Button-1>", self.on_template_label_double_click) 
    ...
    def process_video(self, frame, pose):
        ...
        if not self.grid_rects or 1==1:
            output_image, self.grid_rects = draw_large_chessboard_pattern(frame)
        else:
            output_image = frame.copy()
