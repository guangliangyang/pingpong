...
large_square_size = small_square_size * 8  # 每个大格子的实际大小为80cm
...
# 定义大棋盘格在图像中的起始位置
num_large_squares_x = 4  # 大棋盘格在X方向的数量
...
for i in range(num_large_squares_y + 1):
    for j in range(num_large_squares_x + 1):
        chessboard_physical_points.append([j * large_square_size, -i * large_square_size, 0])
...
# 将大棋盘格子移动到左下角原点位置
#translation_vector = left_bottom_corner - chessboard_image_points_px[-1]
#chessboard_image_points_px += translation_vector
