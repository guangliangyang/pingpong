...
model_file_path = os.path.join('..', 'model', 'pingpong_table_best10.pt')
    ...
    def process_video(self, frame, pose):
        ...
        if results.pose_landmarks:
            ...
            if foot_points:
                ...
                if self.previous_midpoint is not None:
                    ...
                    current_midpoint = [(landmarks[23].x + landmarks[24].x) / 2, (landmarks[23].y + landmarks[24].y) / 2]
                ...
                self.previous_midpoint = [(landmarks[23].x + landmarks[24].x) / 2, (landmarks[23].y + landmarks[24].y) / 2]
        ...
        for result in table_results:
            ...
            for box in boxes:
                ...
                if cls == self.pingpong_class:  # Assuming class 0 is the ping pong table
                    cv2.rectangle(image, (x1, y1), (x2, y2), (255, 0, 0), 2)
                    cv2.putText(image, f'Ping Pong Table {conf:.2f}', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
